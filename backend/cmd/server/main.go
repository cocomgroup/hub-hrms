...
func runMigrations(database *db.Postgres) error {
	...
	migrationFiles := []string{
		...
		"004-create-project.sql",
		"005-create-timesheet-tables.sql",
		"006-create-benefits-table.sql",
		"007-create-pto-tables.sql",
		"008-create-workflows.sql",
		"009-create-payroll.sql",
		"010-create-recruiting.sql",
